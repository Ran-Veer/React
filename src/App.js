...
function App() {
  ...
  return (
    ...
    <div className=" border-2 w-[50%] m-[auto] h-[100%] mt-[6rem]">
      ...
      <button className="hover:bg-green-400 rounded-md bg-green-500 text-white px-[.8rem] py-[.4rem]" onClick={() => setCount (count + 1) }>Increase</button>
      <button className="hover:bg-red-400 rounded-md bg-red-500 text-white px-[.8rem] py-[.4rem]" onClick={() => setCount (count - 1) } disabled={count === 0}>Decrease</button>
